...
public class HistoricoAtividadesActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.fabListarAtv:
                Intent intent = new Intent(HistoricoAtividadesActivity.this, ListarAtividadesActivity.class);
                startActivity(intent);
                break;
            case R.id.fabPerfil:
                intent = new Intent(HistoricoAtividadesActivity.this, MenuActivity.class);
                startActivity(intent);
                break;
            case R.id.fabSair:
