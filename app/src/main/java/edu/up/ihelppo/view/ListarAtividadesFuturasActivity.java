...
public class ListarAtividadesFuturasActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.fabListarAtv:
                Intent intent = new Intent(ListarAtividadesFuturasActivity.this, ListarAtividadesActivity.class);
                startActivity(intent);
                break;
            case R.id.fabPerfil:
                intent = new Intent(ListarAtividadesFuturasActivity.this, MenuActivity.class);
                startActivity(intent);
                break;
            case R.id.fabSair:
                Intent homeIntent = new Intent(ListarAtividadesFuturasActivity.this, MainActivity.class);
